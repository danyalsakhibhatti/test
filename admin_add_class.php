...
if(isset ($_POST['insert'])){
   ...
   $query = "INSERT into class(title) VALUES('$title')";
        ...
        ?></div>
          ...
          <form action="admin_add_class.php" method="post">
            <div class="mb-3">
             ...
             <input type="text" class="form-control" placeholder="Enter Class" name="title"/>
            </div>
             <input class="btn btn-success" type="submit" value="ADD CLASS" name="insert"/>
        </form>
