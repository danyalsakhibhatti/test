...
<html lang="en">
  <head>
    ...
    <title>Student Upload Exam |Web Based Collage Portal</title>
  </head>
  <body>
     <?php
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <div class="card">
              <div class="card-body">
                <form class="row">
                  <div class="mb-3">
                     <label class="form-label h4">Exam Title:</label>
             ...
             <div class="mb-3 col-lg-12">
              ...
              <div class="mb-3">
                <input type="submit" class="btn btn-success" value="Upload Exam"/>
              </div>
              </form>
              </div>
          </div>
