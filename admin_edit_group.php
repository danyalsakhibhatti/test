...
if(isset($_GET['id'])){
    ...
    header('Location: admin_view_group.php');
}
if(isset ($_POST['update'])){
   $title= $_POST['title'];
   $query = "UPDATTE group SET title =$'title' WHERE id = $group_id";
...
$query ="SELECT * FROM section WHERE id = $group_id";
        ...
        ?></div>
          ...
          <form action="admin_add_group.php" method="post">
            <div class="mb-3">
             ...
             <input type="text" class="form-control" placeholder="Enter Group" value=" <?php echo $row['title']; ?>" name="title"/>
            </div>
